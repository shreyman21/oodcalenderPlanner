...
public class ScheduleTest {
  ...
  public void setUp() {
    ...
    event1 = new Event("Test Event 1", startTime, endTime,
            "Location 1", false, null);
    event2 = new Event("Test Event 2", startTime.plusHours(2),
            endTime.plusHours(3), "Location 2", true, null);
  }
  ...
  public void addNullEvent() {
    // adding null event leads to illegal argument
    assertThrows(IllegalArgumentException.class, () -> schedule.addEvent(null));
  }

  @Test
  public void removeNullEvent() {
    // removing null event leads to illegal argument
    assertThrows(IllegalArgumentException.class, () -> schedule.removeEvent(null));
  }

  @Test
  public void addEvent_DuplicateEvent_ThrowsException() {
    // attempting to add duplicate events
    schedule.addEvent(event1);
    assertThrows(IllegalArgumentException.class, () -> schedule.addEvent(event1));
  }
}